INSERT INTO brouwers (BrouwerNr, BrouwerNaam, Adres, PostCode, Gemeente, Omzet) OVERRIDING SYSTEM VALUE  VALUES
...
INSERT INTO brouwers (BrouwerNaam, Adres, PostCode, Gemeente, Omzet)
VALUES ('Nieuwe Brouwerij', 'Nieuwe Straat 1', 1234, 'Nieuwe Stad', 20000);

SELECT last_value FROM brouwers_brouwernr_seq;

SELECT max(brouwernr) FROM brouwers;

ALTER SEQUENCE brouwers_brouwernr_seq RESTART WITH 127;
...
INSERT INTO brouwers (BrouwerNaam, Adres, PostCode, Gemeente, Omzet)
VALUES ('Nieuwe Brouwerij 2', 'Nieuwe Straat 2', 1234, 'Nieuwe Stad', 20000);

SELECT last_value FROM brouwers_brouwernr_seq;

select * from brouwers order by brouwernr desc limit 3 ;

--alter table bieren
--drop constraint bieren_brouwernr_fkey;
